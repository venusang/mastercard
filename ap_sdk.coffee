...
class LoyaltyRtrSdk.collections.AuditAll extends AP.collection.ScopeCollection
  ...
  @type String
  ###
  apiEndpoint: '/api/v10/audits.json'
...
class LoyaltyRtrSdk.collections.BankFaqAll extends AP.collection.ScopeCollection
  ...
  @type String
  ###
  apiEndpoint: '/api/v10/bank_faqs.json'
...
@extends AP.collection.ScopeCollection
###
class LoyaltyRtrSdk.collections.BankOfferReturnActiveBankOffers extends AP.collection.ScopeCollection
  ###*
  The collection ID may be used to look-up a collection from an
  application class.
  @property collectionId
...
@extends AP.collection.ScopeCollection
###
class LoyaltyRtrSdk.collections.GetQuestionAll extends AP.collection.ScopeCollection
  ###*
  The collection ID may be used to look-up a collection from an
  application class.
  @property collectionId
...
@extends AP.collection.AggregateCollection
###
class LoyaltyRtrSdk.collections.GetQuestionCountExactMatch extends AP.collection.AggregateCollection
  ###*
  The collection ID may be used to look-up a collection from an
  application class.
  @property collectionId
...
class LoyaltyRtrSdk.collections.LanguageCodeAll extends AP.collection.ScopeCollection
  ...
  @type String
  ###
  apiEndpoint: '/api/v10/language_codes.json'
...
class LoyaltyRtrSdk.collections.LocalUserStorageAll extends AP.collection.ScopeCollection
  ...
  @type String
  ###
  apiEndpoint: '/api/v10/local_user_storages.json'
...
class LoyaltyRtrSdk.collections.MessageAll extends AP.collection.ScopeCollection
  ...
  @type String
  ###
  apiEndpoint: '/api/v10/messages.json'
...
@extends AP.collection.ScopeCollection
###
class LoyaltyRtrSdk.collections.RtrGetMyRanac extends AP.collection.ScopeCollection
  ###*
  The collection ID may be used to look-up a collection from an
  application class.
  @property collectionId
...
class LoyaltyRtrSdk.collections.UserAll extends AP.collection.ScopeCollection
  ...
  @type String
  ###
  apiEndpoint: '/api/v10/users.json'
