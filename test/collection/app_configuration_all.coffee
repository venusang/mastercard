...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.AppConfigurationAll', ->
  ...
  it 'performs GET requests and, on success, contains model instances of `AppConfiguration`', (done) ->
