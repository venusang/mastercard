(function() {
  ...
  collectionName = 'AppConfigurationAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.AppConfigurationAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `AppConfiguration`', function(done) {
