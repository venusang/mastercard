...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.AppConfigurationExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `AppConfiguration`', (done) ->
