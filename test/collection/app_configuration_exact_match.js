(function() {
  ...
  collectionName = 'AppConfigurationExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.AppConfigurationExactMatch', function() {
    ...
    it('uses the model `AppConfiguration`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `AppConfiguration`', function(done) {
