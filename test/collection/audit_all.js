(function() {
  ...
  collectionName = 'AuditAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.AuditAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `Audit`', function(done) {
