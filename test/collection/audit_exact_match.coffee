...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.AuditExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `Audit`', (done) ->
