(function() {
  ...
  collectionName = 'AuditExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.AuditExactMatch', function() {
    ...
    it('uses the model `Audit`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `Audit`', function(done) {
