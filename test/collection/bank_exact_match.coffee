...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.BankExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `Bank`', (done) ->
