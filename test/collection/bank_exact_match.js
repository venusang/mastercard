(function() {
  ...
  collectionName = 'BankExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.BankExactMatch', function() {
    ...
    it('performs GET requests with query parameters and, on success, contains model instances of `Bank`', function(done) {
