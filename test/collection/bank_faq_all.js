(function() {
  ...
  collectionName = 'BankFaqAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.BankFaqAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `BankFaq`', function(done) {
