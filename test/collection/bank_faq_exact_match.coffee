...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.BankFaqExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `BankFaq`', (done) ->
