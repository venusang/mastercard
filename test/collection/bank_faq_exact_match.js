(function() {
  ...
  collectionName = 'BankFaqExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.BankFaqExactMatch', function() {
    ...
    it('uses the model `BankFaq`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `BankFaq`', function(done) {
