...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.BankOfferAll', ->
  ...
  it 'performs GET requests and, on success, contains model instances of `BankOffer`', (done) ->
