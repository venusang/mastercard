(function() {
  ...
  collectionName = 'BankOfferAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.BankOfferAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `BankOffer`', function(done) {
