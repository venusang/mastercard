...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.BankOfferExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `BankOffer`', (done) ->
