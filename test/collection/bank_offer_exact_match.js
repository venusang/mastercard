(function() {
  ...
  collectionName = 'BankOfferExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.BankOfferExactMatch', function() {
    ...
    it('uses the model `BankOffer`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `BankOffer`', function(done) {
