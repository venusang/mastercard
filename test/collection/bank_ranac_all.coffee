...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.BankRanacAll', ->
  ...
  it 'performs GET requests and, on success, contains model instances of `BankRanac`', (done) ->
