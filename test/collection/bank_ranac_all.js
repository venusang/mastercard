(function() {
  ...
  collectionName = 'BankRanacAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.BankRanacAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `BankRanac`', function(done) {
