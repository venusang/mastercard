...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.BankRanacExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `BankRanac`', (done) ->
