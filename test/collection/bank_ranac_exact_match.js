(function() {
  ...
  collectionName = 'BankRanacExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.BankRanacExactMatch', function() {
    ...
    it('uses the model `BankRanac`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `BankRanac`', function(done) {
