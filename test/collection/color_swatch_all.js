(function() {
  ...
  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.ColorSwatchAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `ColorSwatch`', function(done) {
