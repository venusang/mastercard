...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.ColorSwatchExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `ColorSwatch`', (done) ->
