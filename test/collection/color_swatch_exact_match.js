(function() {
  ...
  collectionName = 'ColorSwatchExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.ColorSwatchExactMatch', function() {
    ...
    it('uses the model `ColorSwatch`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `ColorSwatch`', function(done) {
