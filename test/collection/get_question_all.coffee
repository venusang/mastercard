...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.GetQuestionAll', ->
  ...
  it 'performs GET requests and, on success, contains model instances of `GetQuestion`', (done) ->
