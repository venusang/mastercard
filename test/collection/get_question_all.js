(function() {
  ...
  collectionName = 'GetQuestionAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.GetQuestionAll', function() {
    ...
    it('uses the model `GetQuestion`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests and, on success, contains model instances of `GetQuestion`', function(done) {
