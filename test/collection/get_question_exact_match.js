(function() {
  ...
  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.GetQuestionExactMatch', function() {
    ...
    it('performs GET requests with query parameters and, on success, contains model instances of `GetQuestion`', function(done) {
