...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.LanguageCodeAll', ->
  ...
  it 'performs GET requests and, on success, contains model instances of `LanguageCode`', (done) ->
