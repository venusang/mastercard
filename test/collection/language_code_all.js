(function() {
  ...
  collectionName = 'LanguageCodeAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.LanguageCodeAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `LanguageCode`', function(done) {
