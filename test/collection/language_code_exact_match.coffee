...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.LanguageCodeExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `LanguageCode`', (done) ->
