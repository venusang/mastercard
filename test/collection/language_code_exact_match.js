(function() {
  ...
  collectionName = 'LanguageCodeExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.LanguageCodeExactMatch', function() {
    ...
    it('uses the model `LanguageCode`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `LanguageCode`', function(done) {
