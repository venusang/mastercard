...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.LanguageStringAll', ->
  ...
  it 'performs GET requests and, on success, contains model instances of `LanguageString`', (done) ->
