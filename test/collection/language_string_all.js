(function() {
  ...
  collectionName = 'LanguageStringAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.LanguageStringAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `LanguageString`', function(done) {
