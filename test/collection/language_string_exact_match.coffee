...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.LanguageStringExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `LanguageString`', (done) ->
