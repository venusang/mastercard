...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.LocalUserStorageAll', ->
  ...
  it 'performs GET requests and, on success, contains model instances of `LocalUserStorage`', (done) ->
