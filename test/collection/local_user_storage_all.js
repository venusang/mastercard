(function() {
  ...
  collectionName = 'LocalUserStorageAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.LocalUserStorageAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `LocalUserStorage`', function(done) {
