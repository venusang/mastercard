(function() {
  ...
  describe('Aggregate Collection Class:  LoyaltyRtrSdk.collections.LocalUserStorageCountExactMatch', function() {
    ...
    return it('uses the model `LocalUserStorage`', function() {
