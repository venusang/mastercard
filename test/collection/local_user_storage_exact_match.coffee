...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.LocalUserStorageExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `LocalUserStorage`', (done) ->
