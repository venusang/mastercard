(function() {
  ...
  collectionName = 'LocalUserStorageExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.LocalUserStorageExactMatch', function() {
    ...
    it('uses the model `LocalUserStorage`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `LocalUserStorage`', function(done) {
