(function() {
  ...
  collectionName = 'MessageAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.MessageAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `Message`', function(done) {
