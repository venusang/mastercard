...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.MessageExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `Message`', (done) ->
