(function() {
  ...
  collectionName = 'MessageExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.MessageExactMatch', function() {
    ...
    it('uses the model `Message`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `Message`', function(done) {
