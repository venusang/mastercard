(function() {
  ...
  collectionName = 'RtrAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.RtrAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `Rtr`', function(done) {
