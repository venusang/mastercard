(function() {
  ...
  collectionName = 'RtrCountExactMatch';

  describe('Aggregate Collection Class:  LoyaltyRtrSdk.collections.RtrCountExactMatch', function() {
    ...
    return it('uses the model `Rtr`', function() {
