...
describe 'Scope Collection Class:  LoyaltyRtrSdk.collections.RtrExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `Rtr`', (done) ->
