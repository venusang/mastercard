(function() {
  ...
  collectionName = 'RtrExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.RtrExactMatch', function() {
    ...
    it('uses the model `Rtr`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `Rtr`', function(done) {
