(function() {
  ...
  collectionName = 'UserAll';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.UserAll', function() {
    ...
    it('performs GET requests and, on success, contains model instances of `User`', function(done) {
