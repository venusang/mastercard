(function() {
  ...
  collectionName = 'UserExactMatch';

  describe('Scope Collection Class:  LoyaltyRtrSdk.collections.UserExactMatch', function() {
    ...
    it('uses the model `User`', function() {
      return assert.equal(modelClass, collectionClass.prototype.model);
    });
    it('performs GET requests with query parameters and, on success, contains model instances of `User`', function(done) {
