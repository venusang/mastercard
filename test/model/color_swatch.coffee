...
describe 'Model Class:  LoyaltyRtrSdk.models.ColorSwatch', ->
  ...
  describe 'fields', ->
    ...
    it 'has a field `color_argb` of type `string`', ->
      fieldDefinition = _.findWhere(modelClass::fieldDefinitions, {name: 'color_argb'})
      assert.isDefined fieldDefinition
      assert.equal fieldDefinition.type, 'string'
    
    
    it 'has a field `color_id` of type `string`', ->
      fieldDefinition = _.findWhere(modelClass::fieldDefinitions, {name: 'color_id'})
      assert.isDefined fieldDefinition
      assert.equal fieldDefinition.type, 'string'
