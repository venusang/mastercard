(function() {
  ...
  describe('Model Class:  LoyaltyRtrSdk.models.ColorSwatch', function() {
    ...
    describe('fields', function() {
      ...
      it('has a field `color_argb` of type `string`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
          name: 'color_argb'
        });
        assert.isDefined(fieldDefinition);
      ...
      it('has a field `color_id` of type `string`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
          name: 'color_id'
        });
        assert.isDefined(fieldDefinition);
      ...
      return it('has a field `program_level_id` of type `string`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
