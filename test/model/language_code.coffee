...
describe 'Model Class:  LoyaltyRtrSdk.models.LanguageCode', ->
  ...
  describe 'fields', ->
    ...
    it 'has a field `code` of type `string`', ->
      fieldDefinition = _.findWhere(modelClass::fieldDefinitions, {name: 'code'})
      assert.isDefined fieldDefinition
