(function() {
  ...
  describe('Model Class:  LoyaltyRtrSdk.models.Message', function() {
    ...
    describe('fields', function() {
      ...
      it('has a field `available_points` of type `integer`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
      ...
      it('has a field `created_on` of type `time`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
          name: 'created_on'
        });
        assert.isDefined(fieldDefinition);
      ...
      it('has a field `is_read` of type `boolean`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
          name: 'is_read'
        });
        assert.isDefined(fieldDefinition);
      ...
      it('has a field `last_four_digits` of type `string`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
      ...
      it('has a field `message_field` of type `string`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
          name: 'message_field'
        });
        assert.isDefined(fieldDefinition);
      ...
      it('has a field `message_type` of type `string`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
          name: 'message_type'
        });
        assert.isDefined(fieldDefinition);
      ...
      it('has a field `points_redeemed` of type `integer`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
      ...
      return it('has a field `ranac` of type `string`', function() {
        fieldDefinition = _.findWhere(modelClass.prototype.fieldDefinitions, {
          name: 'ranac'
        });
        assert.isDefined(fieldDefinition);
